...
Start this procedure within the 45-day lead window; investigate persistent issuance or mixed-certificate failures immediately. A successful DNS challenge proves the manual recovery procedure, not future unattended renewal. The recurring operator check must remain active until the traffic policy and automatic renewal path have been verified together.
